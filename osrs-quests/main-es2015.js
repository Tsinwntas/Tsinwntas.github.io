...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>skills works!</p>\n");
...
/* harmony import */ var _skill_skill_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./skill/skill.component */ "./src/app/skill/skill.component.ts");
/* harmony import */ var _quest_quest_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./quest/quest.component */ "./src/app/quest/quest.component.ts");
...
/* harmony import */ var _quests_quests_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./quests/quests.component */ "./src/app/quests/quests.component.ts");
...
const routes = [
    ...
    { path: 'quests', component: _quests_quests_component__WEBPACK_IMPORTED_MODULE_4__["QuestsComponent"] },
    { path: 'quest/:quest', component: _quest_quest_component__WEBPACK_IMPORTED_MODULE_2__["QuestComponent"] },
    { path: 'skills', component: _skills_skills_component__WEBPACK_IMPORTED_MODULE_3__["SkillsComponent"] },
    { path: 'skill/:skill', component: _skill_skill_component__WEBPACK_IMPORTED_MODULE_1__["SkillComponent"] },
...
/* harmony import */ var _quests_quests_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./quests/quests.component */ "./src/app/quests/quests.component.ts");
/* harmony import */ var _quest_quest_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./quest/quest.component */ "./src/app/quest/quest.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _quests_quests_component__WEBPACK_IMPORTED_MODULE_12__["QuestsComponent"],
            _quest_quest_component__WEBPACK_IMPORTED_MODULE_13__["QuestComponent"],
...
let HomeComponent = class HomeComponent {
    ...
    todoQuests() {
        var todo = [];
        this.utils.getTodo().forEach(q => todo.push({ name: q, indent: 0 }));
        if (todo.length == 0)
            return [];
        var index = 0;
        while (todo[index]) {
            todo.splice(index + 1, 0, ...(this.utils.getQuest(todo[index].name).questRequirements.filter(q => !this.utils.isQuestCompleted(q)).map(e => { return { name: e, indent: todo[index].indent + 1 }; })));
            index++;
        }
        return todo;
    }
    todoSkillRequirements() {
        let skills = [];
        this.todoQuests().forEach(q => skills = skills.concat(this.utils.getQuest(q.name).skillRequirements.filter(s => !this.utils.isSkillAchieved(s))));
        return skills.sort((a, b) => this.utils.skills.findIndex(s => s == a.skill) < this.utils.skills.findIndex(s => s == b.skill) ? -1 :
            this.utils.skills.findIndex(s => s == a.skill) > this.utils.skills.findIndex(s => s == b.skill) ? 1 : a.level - b.level);
    }
    getUpcoming() {
        let diffs = ["Novice", "Intermediate", "Special", "Experienced", "Master"];
        let lengths = ["Very short", "Short", "Short – Medium", "Medium", "Medium – Long", "Long", "Long – Very long", "Very long"];
        if (!this.upcoming) {
            let quests = this.todoQuests().filter(q => this.utils.isQuestDoable(q.name)).sort((a, b) => {
                let ind = b.indent - a.indent;
                let diff = diffs.findIndex(d => d == this.utils.getQuest(a.name).diff) - diffs.findIndex(d => d == this.utils.getQuest(b.name).diff);
                let length = lengths.findIndex(l => l == this.utils.getQuest(a.name).length) - lengths.findIndex(l => l == this.utils.getQuest(b.name).length);
...
let QuestComponent = class QuestComponent {
    constructor(route, utils) {
        this.route = route;
        this.utils = utils;
    }
    ngOnInit() {
        this.sub = this.route.params.subscribe(params => {
            this.quest = this.utils.getQuest(this.decode(params['quest']));
        });
    }
    decode(q) {
...
QuestComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _utils_service__WEBPACK_IMPORTED_MODULE_1__["UtilsService"] }
];
QuestComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-quest',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./quest.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/quest/quest.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./quest.component.scss */ "./src/app/quest/quest.component.scss")).default]
    })
], QuestComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QuestsComponent", function() { return QuestsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _utils_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../utils.service */ "./src/app/utils.service.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let QuestsComponent = class QuestsComponent {
    constructor(utils) {
        this.utils = utils;
    }
    ngOnInit() {
    ...
    filter(quests) {
        return quests.filter(q => (!this.name || q.name.toLowerCase().includes(this.name.toLowerCase()))
            && (!this.showOnlyAvailable || this.utils.isQuestDoable(q.name))).sort((a, b) => a.name.replace(/^The[ ]/g, "") < b.name.replace(/^The[ ]/g, "") ? -1 : a.name.replace(/^The[ ]/g, "") > b.name.replace(/^The[ ]/g, ""));
    }
};
QuestsComponent.ctorParameters = () => [
    { type: _utils_service__WEBPACK_IMPORTED_MODULE_1__["UtilsService"] }
];
QuestsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-quests',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./quests.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/quests/quests.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./quests.component.scss */ "./src/app/quests/quests.component.scss")).default]
    })
], QuestsComponent);
...
let SkillComponent = class SkillComponent {
    ...
    related(data, direct) {
        return data.filter(d => (direct && d.skill == this.skill) || (!direct && d.skill == "Skills available"));
    }
    ngOnDestroy() {
        this.sub.unsubscribe();
    }
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _assets_osrs_quests_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../assets/osrs_quests.json */ "./src/assets/osrs_quests.json");
var _assets_osrs_quests_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../assets/osrs_quests.json */ "./src/assets/osrs_quests.json", 1);
/* harmony import */ var _assets_skill_quest_xp_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../assets/skill_quest_xp.json */ "./src/assets/skill_quest_xp.json");
var _assets_skill_quest_xp_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../assets/skill_quest_xp.json */ "./src/assets/skill_quest_xp.json", 1);
...
let UtilsService = class UtilsService {
    constructor() {
        ...
        this.skillQuestXp = _assets_skill_quest_xp_json__WEBPACK_IMPORTED_MODULE_3__.filter(s => s.xp != "Experience\nreward");
    ...
    isCompletedIcon(quest) {
        return this.isQuestCompleted(quest) ? "lens" : "panorama_fish_eye";
    }
    toggleCompleted(quest) {
        let completed = this.getCompleted();
        let index = completed.findIndex(q => q == quest);
        if (index == -1)
            completed.push(quest);
        else {
            completed.splice(index, 1);
            if (this.isQuestTodo(quest))
                this.toggleTodo(quest);
        }
    ...
    toggleTodo(quest) {
        ...
        let index = todo.findIndex(q => q == quest);
        if (index == -1)
            todo.push(quest);
        else
            todo.splice(index, 1);
    ...
    getQuest(quest) {
        let t = this.quests.find(q => q.name == quest);
        if (!t)
            return { name: quest, questRequirements: [], skillRequirements: [] };
        return t;
    }
    fixQuestUrl(quest) {
    ...
    getQuestRequirements(quest) {
        var todo = [];
        todo.push({ name: quest.name, indent: -1 });
        var index = 0;
        while (todo[index]) {
            todo.splice(index + 1, 0, ...(this.getQuest(todo[index].name).questRequirements.map(q => {
                return { name: q, indent: todo[index].indent + 1 };
            })));
            index++;
        }
        todo.splice(0, 1);
    ...
    isQuestDoable(quest) {
        let q = this.getQuest(quest);
        return this.getQuestRequirements(q).filter(e => !this.isQuestCompleted(e.name)).length == 0 &&
            (q.skillRequirements.length == 0 || q.skillRequirements.filter(e => !this.isSkillAchieved(e)).length == 0);
    }
    isSkillAchieved(skill) {
        return this.player[skill.skill] >= skill.level;
    }
    isSkillAchievedIcon(skill) {
        return this.isSkillAchieved(skill) ? "lens" : "panorama_fish_eye";
    }
    getSkillImage(skill) {
        return this.skillImages[this.skills.findIndex(s => s == skill.skill)];
    }
    getSkillReqInfo(skill) {
        return skill.skill + ": " + skill.level + " " + skill.extra;
    }
    toggleSkill(skill) {
        if (!this.isSkillAchieved(skill))
            this.player[skill.skill] = skill.level;
    }
};
...
module.exports = __webpack_require__(/*! C:\Users\Tsinik\Desktop\workspace\Angular\osrs-quests\src\main.ts */"./src/main.ts");
